...
#    print("Embeddings shape:", all_embeddings.shape)
    ...
    X_ = X[:5120]
    y_ = y[:5120]
    embeddings_ = embeddings[:5120]
    
    return X_, y_, embeddings_
...
batch_size = 64
z_dim = 100
stage1_generator_lr = 0.0005
stage1_discriminator_lr = 0.0005
...
log_folder = dir_to_change + "Output_Folder/stage1_gan_logs/"
...
#            print("g_loss:{}".format(g_loss))
        ...
        all_gen_loss.append(np.mean(dis_losses))
        all_dis_loss.append(np.mean(gen_losses[0]))
...
df = pd.DataFrame(data={"col1": all_gen_loss, "col2": all_dis_loss})
df.to_csv("./stage1 losses.csv", sep=',',index=False)
