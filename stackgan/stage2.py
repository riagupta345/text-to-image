...
all_gen_loss = []
all_disc_loss = []
dir_results =dir_to_change+"Output_Folder/model1_stage2_results/"
...
stage1_gen.load_weights(dir_weights+"stage1_gen.h5")
...
# Saving the models
dir_weights = dir_to_change+"Output_Folder/"
stage2_gen.save_weights(dir_weights+"model1_stage2_gen.h5")
stage2_dis.save_weights(dir_weights+"model1_stage2_dis.h5")
...
df.to_csv("./Model 1 stage2 losses.csv", sep=',',index=False)
